  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-pink-50 to-purple-50 p-4">
      <div className="w-full max-w-md rounded-lg bg-white p-8 shadow-lg">
        ...
        <p className="mt-2 text-gray-600">Login to sweetsweat</p>
        <form className="mt-6 space-y-4">
          ...
          <button type="submit" className="w-full rounded-lg bg-pink-500 py-2 font-semibold text-white hover:bg-pink-600">Login</button>
        </form>
        <p className="mt-4 text-center text-gray-600">
          Don't have an account? <a href="/auth/register" className="font-semibold text-pink-500 hover:underline">Sign up</a>
        </p>
      </div>
    </div>
  )
